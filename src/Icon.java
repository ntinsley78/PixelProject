...
public class Icon
{
	...
	public void setRed (int row, int col, int r) throws exceptionList //red
	{
		icon.get(row).get(col).setRed(r);
	}
	
	public void setGreen (int row, int col, int g) throws exceptionList //Green
	{
		icon.get(row).get(col).setGreen(g);
	}
	
	public void setBlue (int row, int col, int b) throws exceptionList //blue
	{
